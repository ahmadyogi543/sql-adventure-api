-- mock users table
INSERT OR IGNORE INTO users (id, name, email, institution, password_hash, role) VALUES
...
INSERT OR IGNORE INTO users_progress (id, user_id, stage_id, no_of_missions, score, last_attempted)
VALUES
...
INSERT OR IGNORE INTO missions_attempted (id, users_progress_id, mission_id, mission_name, attempt, last_attempted)
VALUES
